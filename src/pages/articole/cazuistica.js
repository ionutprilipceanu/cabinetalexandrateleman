        ...
        <article>
          ...
          <div className="text-articole">
            <ol>
              ...
              <dd>
                - teama de a zbura cu avionul, a merge sau a conduce mașina etc
              </dd>
              <dd>- claustrofobie</dd>
              <dd>- fobie socială</dd>
              ...
              <dd>- Dureri sau imposibilitatea de a urina</dd>
              <dd>- Lipsa apetitului și frica de a mânca</dd>
              <dd>
                - Tremur la nivelul mainilor sau diverse spasme ale corpului
              </dd>
              ...
              <li>
                Probleme legate de instabilitatea emoțională și lipsa
                autocontrolului
              </li>
              <li>Tulburări de personalitate borderline</li>
              <li>
                Probleme de integrare și relaționare inter-individuală sau de
                grup
              </li>
