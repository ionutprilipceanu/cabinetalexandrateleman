    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            property="og:url"
            content="https://www.psiholog-iasi-teleman.com/articole/depresia/"
          />
          <meta property="og:type" content="website" />
          <meta
            property="og:title"
        ...
        <article>
          ...
          <div className="text-articole">
            <p>
              ...
              gândești și felul în care te comporți. Din fericire este
              tratabilă. Depresia declanșează sentimente de tristețe sau
              pierderea interesului acelor activități care înainte îți ofereau
              plăcere. Tulburarea depresivă poate fi legată de numeroase
            ...
            <p>
              <ul>
                <h3>
                  Simptomele depresive pot varia de la simptome medii la
                  simptome severe, precum:
                </h3>
                <li>Sentimente de tristețe sau stare depresivă;</li>
                <li>
                  Pierderea interesului sau a plăcerii activității care înainte
                  îți oferea plăcere;
                </li>
                ...
                <li>
                  Creșterea activității fizice fără scop (de exemplu
                  incapacitatea de a sta liniștit, ritmul, rotirea mâinilor) sau
                  vorbirea încetinită (aceste acțiuni trebuie să fie suficient
                  de severe pentru a fi observate de către ceilalți);
                </li>
                <li>
                  Trăirea sentimentului de vid și lipsa valorii personale sau
            ...
            <p>
              ...
              reprezinte o schimbare a nivelului anterior de funcționare.
              Depresia afectează 1 adult din 15, (6,7%) într-un an, iar 1
              persoane din 6 va dezvolta depresie pe parcursul vieții ei
              (16,6%). Depresia poate apărea la orice moment din viață, însă
