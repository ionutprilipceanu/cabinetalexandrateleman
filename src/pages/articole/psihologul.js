    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            property="og:url"
            content="https://www.psiholog-iasi-teleman.com/articole/psihologul/"
          />
          <meta property="og:type" content="website" />
          <meta
            property="og:title"
        ...
        <article>
          ...
          <div className="text-articole">
            <p>
              Nu există un manual care să stipuleze care sunt pașii, după care
              ar trebui să ne alegem psihologul. Cu toate acestea este important
              să înțelegem care sunt aștepările noastre în urma intervenției
              psihologice, pentru a avea un rezultat pe măsură. De cele mai
              multe ori oamenii aleg să meargă la un psiholog recomandat de
              alții, văzut la televizor, la autorul unei cărți, de pe Internet
              etc. Cu toate acestea vă puteți întreba dacă ați ajuns exact la
              psihologul de care aveți nevoie. Iată câte idei în funcție de care
              vă puteți alege psihologul:
              <ul>
                ...
                <li>
                  Dacă contează vârsta și genul psihologului, bineînțeles veți
                  ține cont și de aceste aspecte.
                </li>
              </ul>
            </p>
            ...
            <p>
              ...
              psihoterapeutul. Pentru că suntem ființe umane și reacționăm la
              schimbul de energie și emoție, atunci când veți simți că trăiți la
              unison cu terapeutul vostru, înseamnă că ați ales psihologul
              perfect pentru voi. Există clienți care au schimbat până la patru
              psihologi până au găsit psihologul ,,perfect" pentru ei. Dacă
              simțiți că nu rezonați cu un anumit psiholog este perfect normal
              să mai încercați și altceva.
            </p>

            <p>
              Bernard G, Valerie Jalfre <i>Les Psychoterapies (2008)</i>
            </p>
          </div>
        </article>
        <FooterBottom />
