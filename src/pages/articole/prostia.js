    ...
    return (
      <div>
        <Helmet>
          ...
          <meta
            property="og:url"
            content="https://www.psiholog-iasi-teleman.com/articole/prostia/"
          />
          <meta property="og:type" content="website" />
          <meta
            property="og:title"
        ...
        <article>
          ...
          <div className="text-articole">
            <p>
              Plecând de la binele cunoscut proverb românesc care spune "Prostia
              este omenească" putem înțelege foarte multe lucruri. În primul
              rând putem înțelege că prostia este un efect cauzat de om. În al
              doilea rând înțelegem că omul stabilește ce e prostie și ce nu e
              prostie. În al treilea rând, putem înțelege că prostia
              sălășluiește printre oameni. Cu alte cuvinte, poate exista între
            ...
            <p>
              ...
              <i>"Ce prost am fost!"</i>, așadar uneori prostia poate apărea
              doar prin intermediul propriilor reflecții, la nivel individual
              fără a fi nevoie de un al doilea participant. Mărturisesc faptul
              că mult timp am suferit din cauza prostiei. Din cauza faptului că
              nu puteam tolera prostia. Aceea prostie văzută la ceilalți prin
            ...
            <p>
              ...
              Capitolul patru din această carte mi-a domolit revolta asupra
              prostiei. Cum altfel să se fi întâmplat când chiar Pleșu, afirma
              că prostia există pur și simplu, indiferent de nivelul educației
              sau al inteligenței, diferența o face doar nivelul de manifestare.
              Cum o fi prostia în cazul intelectualilor comparativ cu prostia
              angajaților de la drumuri și poduri? O fi mai mare, o fi mai mică?
              Despre inimă și alte eseuri, o carte care te îmbie la reflecție,
              la înțelegere și acceptare. <br />
