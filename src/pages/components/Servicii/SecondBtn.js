    ...
    <div>
      <button className="btn-alls btn-gos"  onClick={() => setModalIsOpen(true)}>Citește mai mult</button>
        ...
        <Modal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)} ariaHideApp={false} className="modalOpen">
          <Zoom>
            <h1 className="ModalTitle">Terapie de familie</h1>
            <p className="ModalText"> Această formă de terapie are în prin plan reconcilierea cuplului și a familiei, ca atare participanții la terapie vor fi cuplul, cât și copiii, de la caz la caz. Durata terapiei poate oscila între 60 minute și 1h30 minute. Strategia de intervenție va fi personalizată în funcție de particularitățile cuplului.<br/></p>
