  ...
  render() {
    ...
    return (
      <div className="nav_body">
        ...
        <div className="logo">
          <Link to="/" className="link-img" ><img src={logo} alt="Logo" /></Link>
        </div>
          ...
          {this.state.hider ?
            <div className="nav-bar ">
              ...
              <ul className="nav-bar">
                ...
                <li><a href="https://www.facebook.com/Cabinet-Psihologic-Teleman-662227117527601" target="_blank" rel="noreferrer" className="logoFacebookNav"> <FontAwesomeIcon icon={faFacebook} /> </a></li>
              </ul>
            </div>
            :
            ...
            <ul className="navSide">
              ...
              <li>
                ...
                <a href="https://github.com/ionutprilipceanu" target="_blank" rel="noreferrer" className="logoGithub"> <FontAwesomeIcon icon={faGithub} /></a> */}
                  <a href="https://www.facebook.com/Cabinet-Psihologic-Teleman-662227117527601" target="_blank" rel="noreferrer" className="logoFacebook"> <FontAwesomeIcon icon={faFacebook} /></a>
                </div>
              </li>
            </ul>
