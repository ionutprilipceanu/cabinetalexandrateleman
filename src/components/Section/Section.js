        ...
        <Fade>
          ...
          <div className="cardStyle">
            ...
            <Card className="card-Container" style={{ width: '20rem' }}>
              ...
              <Card.Body>
                <Card.Title className="title-Card-title">Casuistique personnelle</Card.Title>
                <Card.Text>
                Vous pouvez voir mon cas des deux dernières années en accédant au bouton ci-dessous...
                  </Card.Text>
                <Button variant="dark"><Link
                  to="/section/cazuisticaFr/"
                  className="link-articole"
                > Lire la suite </Link>
                </Button>
              </Card.Body>
