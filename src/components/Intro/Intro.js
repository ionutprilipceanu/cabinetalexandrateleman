          ...
          <Card className="about_body">
            <Card.Body>
              ...
              <div className="aboutContent">
                ...
                Noi știm că după toate va ieși și soarele!
